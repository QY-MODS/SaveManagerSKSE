...
std::map<std::string, std::pair<bool, SaveSettings::Scenarios>> SaveSettings::Menu::Open {
    ...
    {std::string(RE::CraftingMenu::MENU_NAME), {false, SaveSettings::Scenarios::MenuOpenCraftingMen}},
    ...
    {std::string(RE::MessageBoxMenu::MENU_NAME), {false, SaveSettings::Scenarios::MenuOpenMessageBoxMen}},
...
std::map<std::string, std::pair<bool,SaveSettings::Scenarios>> SaveSettings::Menu::Close{
    ...
    {std::string(RE::CraftingMenu::MENU_NAME), {false, SaveSettings::Scenarios::MenuCloseCraftingMen}},
    ...
    {std::string(RE::MessageBoxMenu::MENU_NAME), {false, SaveSettings::Scenarios::MenuCloseMessageBoxMen}},
